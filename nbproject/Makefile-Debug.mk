...
${OBJECTDIR}/method_de_matrix.o: method_de_matrix.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/method_de_matrix.o method_de_matrix.c
...
${OBJECTDIR}/method_de_matrix_nomain.o: ${OBJECTDIR}/method_de_matrix.o method_de_matrix.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/method_de_matrix_nomain.o method_de_matrix.c;\
	else  \
